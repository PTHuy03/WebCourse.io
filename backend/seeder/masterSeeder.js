      ...
      if (course.title.includes("Python") && course.title.includes("cơ bản")) {
        courseLessons = [
          // Chapter 1
          {
            ...
            content: "Tổng quan về Python.",
            order: 1,
            chapter: 1,
          },
          {
            title: "Cài đặt môi trường",
            content: "Hướng dẫn cài đặt Python.",
            order: 2,
            chapter: 1,
          },
          {
            title: "Biến và kiểu dữ liệu",
            content: "Biến, kiểu số, chuỗi, boolean.",
            order: 3,
            chapter: 1,
          },
          {
          ...
          { title: "Vòng lặp", content: "for, while.", order: 5, chapter: 1 },
          {
            title: "Hàm",
            content: "Định nghĩa và gọi hàm.",
            order: 6,
            chapter: 1,
          },
          {
          ...
          // Chapter 2
          {
            ...
            content: "Cách sử dụng danh sách trong Python.",
            order: 1,
            chapter: 2,
          },
          {
            title: "Tuple và Set",
            content: "Giới thiệu tuple và set.",
            order: 2,
            chapter: 2,
          },
          {
            title: "Từ điển (Dictionary)",
            content: "Cách làm việc với dictionary.",
            order: 3,
            chapter: 2,
          },
          {
          ...
          },
          {
            ...
            content: "Đọc và ghi file trong Python.",
            order: 5,
            chapter: 2,
          },
          {
            title: "Module và Package",
            content: "Sử dụng module và package.",
            order: 6,
            chapter: 2,
          },
        ];
        ...
        course.title.includes("nâng cao")
      ) {
        courseLessons = [
          {
            title: "Decorator trong Python",
            content: "Trang trí hàm.",
            order: 1,
            chapter: 1,
          },
          {
            title: "Generator",
            content: "Sinh dữ liệu lười.",
            order: 2,
            chapter: 1,
          },
          {
            title: "Xử lý ngoại lệ nâng cao",
            content: "Try, except, raise.",
            order: 3,
            chapter: 2,
          },
          {
          ...
          },
          {
            ...
            content: "Threading, multiprocessing.",
            order: 7,
            chapter: 4,
          },
        ];
        ...
        courseLessons = [
          {
            ...
            content: "Lập trình tổng quát.",
            order: 1,
            chapter: 1,
          },
          {
            title: "STL nâng cao",
            content: "Vector, Map, Set.",
            order: 2,
            chapter: 1,
          },
          {
            title: "Quản lý bộ nhớ",
            content: "Smart pointer.",
            order: 3,
            chapter: 2,
          },
          {
            title: "Lập trình đa luồng",
            content: "Thread, mutex.",
            order: 4,
            chapter: 3,
          },
          {
        ...
        courseLessons = [
          {
            title: "Giới thiệu C++",
            content: "Tổng quan về C++.",
            order: 1,
            chapter: 1,
          },
          {
            title: "Cài đặt môi trường",
            content: "Hướng dẫn cài đặt C++.",
            order: 2,
            chapter: 1,
          },
          {
            title: "Biến và kiểu dữ liệu",
            content: "int, float, char, string.",
            order: 3,
            chapter: 2,
          },
          {
          ...
          {
            title: "Con trỏ",
            content: "Pointer trong C++.",
            order: 7,
            chapter: 4,
          },
          {
            title: "Lập trình hướng đối tượng",
            content: "Class, object, kế thừa.",
            order: 8,
            chapter: 5,
          },
        ];
        ...
        courseLessons = [
          {
            ...
            content: "Tổng quan về JavaScript.",
            order: 1,
            chapter: 1,
          },
          {
            title: "Biến và kiểu dữ liệu",
            content: "var, let, const, kiểu dữ liệu.",
            order: 2,
            chapter: 1,
          },
          {
            title: "Toán tử",
            content: "Toán tử số học, logic.",
            order: 3,
            chapter: 2,
          },
          {
          ...
          {
            title: "Hàm",
            content: "Function declaration, expression, arrow.",
            order: 6,
            chapter: 3,
          },
          {
            title: "DOM",
            content: "Tương tác với HTML.",
            order: 7,
            chapter: 4,
          },
          { title: "Event", content: "Xử lý sự kiện.", order: 8, chapter: 4 },
        ];
      } else if (
        course.title.includes("SQL") &&
        course.title.includes("nâng cao")
      ) {
        courseLessons = [
          {
            title: "Stored Procedure",
            content: "Thủ tục lưu trữ.",
            order: 1,
            chapter: 1,
          },
          {
            title: "Trigger",
            content: "Kích hoạt tự động.",
            order: 2,
            chapter: 1,
          },
          { title: "Transaction", content: "Giao dịch.", order: 3, chapter: 2 },
          { title: "Index", content: "Chỉ mục.", order: 4, chapter: 3 },
          {
        ...
        courseLessons = [
          {
            ...
            content: "Tổng quan về SQL.",
            order: 1,
            chapter: 1,
          },
          {
            title: "Cơ sở dữ liệu quan hệ",
            content: "Khái niệm cơ bản.",
            order: 2,
            chapter: 1,
          },
          {
          ...
          {
            title: "Câu lệnh INSERT",
            content: "Thêm dữ liệu.",
            order: 4,
            chapter: 2,
          },
          {
            title: "Câu lệnh UPDATE",
            content: "Cập nhật dữ liệu.",
            order: 5,
            chapter: 3,
          },
          {
            title: "Câu lệnh DELETE",
            content: "Xóa dữ liệu.",
            order: 6,
            chapter: 3,
          },
          { title: "JOIN", content: "Kết hợp bảng.", order: 7, chapter: 4 },
          {
